...
var $;
layui.config({
	base : "/themes/simpleboot3/public/layui/lay/modules/"
	...
	var layer = parent.layer === undefined ? layui.layer : parent.layer;
        ...
        loadProvince();
        layui.upload({
        	url : "/themes/simpleboot3/public/user/json/userface.json",
        ...
        if(window.sessionStorage.getItem('userFace')){
        	...
        	$("#userFace").attr("src","/themes/simpleboot3/public/user/images/face.jpg");
        }
